if(typeof THREE.Projector==="undefined") {
THREE.Projector=function(){function e(){var e=v[p]=v[p]||new THREE.RenderableObject;return p++,e}function n(){var e=R[y]=R[y]||new THREE.RenderableVertex;return y++,e}function t(){var e=b[E]=b[E]||new THREE.RenderableFace3;return E++,e}function o(){var e=w[d]=w[d]||new THREE.RenderableFace4;return d++,e}function i(){var e=T[f]=T[f]||new THREE.RenderableLine;return f++,e}function r(){var e=H[h]=H[h]||new THREE.RenderableParticle;return h++,e}function c(e,n){return n.z-e.z}function s(e){for(var n,t=e.matrixWorld,o=-e.geometry.boundingSphere.radius*Math.max(e.scale.x,Math.max(e.scale.y,e.scale.z)),i=0;6>i;i++)if(n=W[i].x*t.n14+W[i].y*t.n24+W[i].z*t.n34+W[i].w,o>=n)return!1;return!0}function l(e,n){var t=0,o=1,i=e.z+e.w,r=n.z+n.w,c=-e.z+e.w,s=-n.z+n.w;return i>=0&&r>=0&&c>=0&&s>=0?!0:0>i&&0>r||0>c&&0>s?!1:(0>i?t=Math.max(t,i/(i-r)):0>r&&(o=Math.min(o,i/(i-r))),0>c?t=Math.max(t,c/(c-s)):0>s&&(o=Math.min(o,c/(c-s))),t>o?!1:(e.lerpSelf(n,t),n.lerpSelf(e,1-o),!0))}var a,p,u,y,m,E,d,x,f,S,h,v=[],R=[],b=[],w=[],T=[],H=[],V={objects:[],sprites:[],lights:[],elements:[]},z=new THREE.Vector3,j=new THREE.Vector4,g=new THREE.Matrix4,M=new THREE.Matrix4,W=[new THREE.Vector4,new THREE.Vector4,new THREE.Vector4,new THREE.Vector4,new THREE.Vector4,new THREE.Vector4],I=new THREE.Vector4,F=new THREE.Vector4;this.computeFrustum=function(e){W[0].set(e.n41-e.n11,e.n42-e.n12,e.n43-e.n13,e.n44-e.n14),W[1].set(e.n41+e.n11,e.n42+e.n12,e.n43+e.n13,e.n44+e.n14),W[2].set(e.n41+e.n21,e.n42+e.n22,e.n43+e.n23,e.n44+e.n24),W[3].set(e.n41-e.n21,e.n42-e.n22,e.n43-e.n23,e.n44-e.n24),W[4].set(e.n41-e.n31,e.n42-e.n32,e.n43-e.n33,e.n44-e.n34),W[5].set(e.n41+e.n31,e.n42+e.n32,e.n43+e.n33,e.n44+e.n34);for(var n=0;6>n;n++){var t=W[n];t.divideScalar(Math.sqrt(t.x*t.x+t.y*t.y+t.z*t.z))}},this.projectVector=function(e,n){return n.matrixWorldInverse.getInverse(n.matrixWorld),g.multiply(n.projectionMatrix,n.matrixWorldInverse),g.multiplyVector3(e),e},this.unprojectVector=function(e,n){return n.projectionMatrixInverse.getInverse(n.projectionMatrix),g.multiply(n.matrixWorld,n.projectionMatrixInverse),g.multiplyVector3(e),e},this.pickingRay=function(e,n){var t;return e.z=-1,t=new THREE.Vector3(e.x,e.y,1),this.unprojectVector(e,n),this.unprojectVector(t,n),t.subSelf(e).normalize(),new THREE.Ray(e,t)},this.projectGraph=function(n,t){p=0,V.objects.length=0,V.sprites.length=0,V.lights.length=0;var o=function(n){if(n.visible!==!1){(n instanceof THREE.Mesh||n instanceof THREE.Line)&&(n.frustumCulled===!1||s(n))?(g.multiplyVector3(z.copy(n.position)),a=e(),a.object=n,a.z=z.z,V.objects.push(a)):n instanceof THREE.Sprite||n instanceof THREE.Particle?(g.multiplyVector3(z.copy(n.position)),a=e(),a.object=n,a.z=z.z,V.sprites.push(a)):n instanceof THREE.Light&&V.lights.push(n);for(var t=0,i=n.children.length;i>t;t++)o(n.children[t])}};return o(n),t&&V.objects.sort(c),V},this.projectScene=function(e,s,a){var p,v,b,w,T,H,z,W,P,L,C,A,D,G,N,k,q,O,U,B,J,K,Q,X,Y,Z,$,_,en,nn=s.near,tn=s.far;for(E=0,d=0,f=0,h=0,V.elements.length=0,void 0===s.parent&&(console.warn("DEPRECATED: Camera hasn't been added to a Scene. Adding it..."),e.add(s)),e.updateMatrixWorld(),s.matrixWorldInverse.getInverse(s.matrixWorld),g.multiply(s.projectionMatrix,s.matrixWorldInverse),this.computeFrustum(g),V=this.projectGraph(e,!1),p=0,v=V.objects.length;v>p;p++)if(D=V.objects[p].object,G=D.matrixWorld,k=D.material,y=0,D instanceof THREE.Mesh){for(q=D.geometry,O=D.geometry.materials,U=q.vertices,B=q.faces,X=q.faceVertexUvs,N=D.matrixRotationWorld.extractRotation(G),b=0,w=U.length;w>b;b++)u=n(),u.positionWorld.copy(U[b].position),G.multiplyVector3(u.positionWorld),u.positionScreen.copy(u.positionWorld),g.multiplyVector4(u.positionScreen),u.positionScreen.x/=u.positionScreen.w,u.positionScreen.y/=u.positionScreen.w,u.visible=u.positionScreen.z>nn&&u.positionScreen.z<tn;for(T=0,H=B.length;H>T;T++){if(J=B[T],J instanceof THREE.Face3){if(Z=R[J.a],$=R[J.b],_=R[J.c],!(Z.visible&&$.visible&&_.visible)||!D.doubleSided&&D.flipSided==(_.positionScreen.x-Z.positionScreen.x)*($.positionScreen.y-Z.positionScreen.y)-(_.positionScreen.y-Z.positionScreen.y)*($.positionScreen.x-Z.positionScreen.x)<0)continue;m=t(),m.v1.copy(Z),m.v2.copy($),m.v3.copy(_)}else if(J instanceof THREE.Face4){if(Z=R[J.a],$=R[J.b],_=R[J.c],en=R[J.d],!(Z.visible&&$.visible&&_.visible&&en.visible)||!D.doubleSided&&D.flipSided==((en.positionScreen.x-Z.positionScreen.x)*($.positionScreen.y-Z.positionScreen.y)-(en.positionScreen.y-Z.positionScreen.y)*($.positionScreen.x-Z.positionScreen.x)<0||($.positionScreen.x-_.positionScreen.x)*(en.positionScreen.y-_.positionScreen.y)-($.positionScreen.y-_.positionScreen.y)*(en.positionScreen.x-_.positionScreen.x)<0))continue;m=o(),m.v1.copy(Z),m.v2.copy($),m.v3.copy(_),m.v4.copy(en)}for(m.normalWorld.copy(J.normal),N.multiplyVector3(m.normalWorld),m.centroidWorld.copy(J.centroid),G.multiplyVector3(m.centroidWorld),m.centroidScreen.copy(m.centroidWorld),g.multiplyVector3(m.centroidScreen),K=J.vertexNormals,z=0,W=K.length;W>z;z++)Q=m.vertexNormalsWorld[z],Q.copy(K[z]),N.multiplyVector3(Q);for(P=0,L=X.length;L>P;P++)if(Y=X[P][T])for(C=0,A=Y.length;A>C;C++)m.uvs[P][C]=Y[C];m.material=k,m.faceMaterial=null!==J.materialIndex?O[J.materialIndex]:null,m.z=m.centroidScreen.z,V.elements.push(m)}}else if(D instanceof THREE.Line)for(M.multiply(g,G),U=D.geometry.vertices,Z=n(),Z.positionScreen.copy(U[0].position),M.multiplyVector4(Z.positionScreen),b=1,w=U.length;w>b;b++)Z=n(),Z.positionScreen.copy(U[b].position),M.multiplyVector4(Z.positionScreen),$=R[y-2],I.copy(Z.positionScreen),F.copy($.positionScreen),l(I,F)&&(I.multiplyScalar(1/I.w),F.multiplyScalar(1/F.w),x=i(),x.v1.positionScreen.copy(I),x.v2.positionScreen.copy(F),x.z=Math.max(I.z,F.z),x.material=k,V.elements.push(x));for(p=0,v=V.sprites.length;v>p;p++)D=V.sprites[p].object,G=D.matrixWorld,D instanceof THREE.Particle&&(j.set(G.n14,G.n24,G.n34,1),g.multiplyVector4(j),j.z/=j.w,j.z>0&&j.z<1&&(S=r(),S.x=j.x/j.w,S.y=j.y/j.w,S.z=j.z,S.rotation=D.rotation.z,S.scale.x=D.scale.x*Math.abs(S.x-(j.x+s.projectionMatrix.n11)/(j.w+s.projectionMatrix.n14)),S.scale.y=D.scale.y*Math.abs(S.y-(j.y+s.projectionMatrix.n22)/(j.w+s.projectionMatrix.n24)),S.material=D.material,V.elements.push(S)));return a&&V.elements.sort(c),V}};
}
...
if(typeof window.i18n==="undefined"){window.i18n=(function(){return{default:{}};})();
}
/**
...
//    };
    ...
    var __ = function(key, language) {
        ...
        if(typeof i18n[language] === "undefined") {
            return typeof i18n['default'][key] === "undefined" ? key : i18n['default'][key];
        }
